...
//    .defer(d3.json, web_service_url+'dataset/terms?size=40&domain=ega&field=sample_protocol') // geojson points
    ...
    function draw_word_cloud(error,
                             pride_des, pepatlas_des, massive_des, metabol_des, metabow_des, omics_des,
                             pride_datap, metabol_datap, metabow_datap, omics_datap,
                             pride_samp, metabol_samp, metabow_samp, omics_samp) {
        if (error) {
            outputerrorinfo();
            return;
        }
