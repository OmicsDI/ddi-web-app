...
@Component({
  selector: 'app-profile-pager',
  templateUrl: './profile-pager.component.html',
  styleUrls: ['./profile-pager.component.css']
})
export class ProfilePagerComponent implements OnInit {
