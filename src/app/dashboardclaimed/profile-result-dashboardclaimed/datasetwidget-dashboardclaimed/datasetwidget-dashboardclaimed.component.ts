...
@Component({
    selector: 'app-datasetwidget-dashboardclaimed',
    templateUrl: './datasetwidget-dashboardclaimed.component.html',
    styleUrls: ['./datasetwidget-dashboardclaimed.component.css']
})

export class DatasetwidgetDashboardclaimedComponent implements OnInit {
