...
@Component({
    selector: 'app-omics-image-dashboardclaimed',
    templateUrl: './omics-image-dashboardclaimed.component.html',
    styleUrls: ['./omics-image-dashboardclaimed.component.css']
})
export class OmicsImageDashboardclaimedComponent implements OnInit, OnChanges {
