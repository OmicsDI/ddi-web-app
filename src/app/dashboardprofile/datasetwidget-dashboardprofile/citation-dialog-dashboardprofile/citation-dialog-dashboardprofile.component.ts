...
@Component({
    selector: 'app-citation-dialog-dashboardprofile',
    templateUrl: './citation-dialog-dashboardprofile.component.html',
    styleUrls: ['./citation-dialog-dashboardprofile.component.css']
})
export class CitationDialogDashboardprofileComponent implements OnInit {
    ...
    constructor(public dialogRef: MatDialogRef<CitationDialogDashboardprofileComponent>) {
    }
    ...
    /**************************************************************************
     ...
     amicyanin and cytochrome c551i from Paracoccus denitrificans with the substrate-reduced, copper free
     complex at 1.9 A resolution, Protein Data Bank, V1. http://identifiers.org/pdb:2gc4.

     *** Some notes here: In bold the Name of the Database or Provider. Also the version. For now all of
     * our versions will be V1 until we start controlling the versioning.

     AMA style:
     [dataset] 27. Chen Z, Durley R, Davidson VL, Mathews FS. Structural comparison of the oxidized
     ternary electron transfer complex of methylamine dehydrogenase, amicyanin and cytochrome c551i
     from Paracoccus denitrificans with the substrate-reduced, copper free complex at 1.9 A resolution,
     Protein Data Bank, V1; 2006. http://identifiers.org/pdb:2gc4.
     ***********************************************************************/
