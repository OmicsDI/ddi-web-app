...
@Component({
    ...
    templateUrl: './datasetwidget-dashboardprofile.component.html',
    styleUrls: ['./datasetwidget.component-dashboardprofile.css']
})
export class DatasetwidgetDashboardprofileComponent implements OnInit {
