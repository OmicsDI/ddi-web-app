...
@Component({
    selector: 'app-omics-image-search-datasetselected',
    templateUrl: './omics-image-search-datasetselected.component.html',
    styleUrls: ['./omics-image-search-datasetselected.component.css']
})
export class OmicsImageSearchDatasetselectedComponent implements OnInit, OnChanges {
