...
@Component({
    selector: 'app-omics-image-datasetwidget-profile',
    templateUrl: './omics-image-datasetwidget-profile.component.html',
    styleUrls: ['./omics-image-datasetwidget-profile.component.css']
})
export class OmicsImageDatasetwidgetProfileComponent implements OnInit, OnChanges {
