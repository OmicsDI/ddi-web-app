...
@Component({
    selector: 'app-datasetwidget-profile',
    templateUrl: './datasetwidget-profile.component.html',
    styleUrls: ['./datasetwidget-profile.component.css']
})
export class DatasetWidgetProfileComponent implements OnInit {
