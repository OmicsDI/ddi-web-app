...
@Component({
    selector: 'app-dashboard-claim-count-profile',
    templateUrl: './dashboard-claim-count-profile.component.html',
    styleUrls: ['./dashboard-claim-count-profile.component.css']
})
export class DashboardClaimCountProfileComponent implements OnInit, OnChanges {
        ...
        svg.selectAll('circle')
            ...
            .on('click', function (d) {
                ...
                const searchWord = '*:* AND omics_type:"'
                    + DashboardClaimCountProfileComponent.getName(d['year'], d['value'], annualDataExtends)
    ...
    private initSvg(body: any): any {
        ...
        const latestDatasetsDivHeightPx = d3.select('#barchart_claim_dashboard').style('height');
