...
export class DashboardConnectionsCountProfileComponent implements OnInit {
    ...
    private initSvg(body : any): any {
        ...
        let latestDatasetsDivHeightPx = d3.select('#barchart_connections_dashboard').style('height');
