...
@Component({
    selector: 'app-dashboard-connections-count-profile',
    templateUrl: './dashboard-connections-count-profile.component.html',
    styleUrls: ['./dashboard-connections-count-profile.component.css']
})
export class DashboardConnectionsCountProfileComponent implements OnInit, OnChanges {
        ...
        svg.selectAll('circle')
            ...
            .on('click', function (d) {
                ...
                const searchWord = '*:* AND omics_type:"'
                    + DashboardConnectionsCountProfileComponent.getName(d['year'], d['value'], annualDataExtends)
    ...
    private initSvg(body: any): any {
        ...
        const latestDatasetsDivHeightPx = d3.select('#barchart_connections_dashboard').style('height');
