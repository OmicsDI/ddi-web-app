...
@Component({
    selector: 'app-dashboard-reanalisys-count-profile',
    templateUrl: './dashboard-reanalisys-count-profile.component.html',
    styleUrls: ['./dashboard-reanalisys-count-profile.component.css']
})
export class DashboardReanalisysCountProfileComponent implements OnInit, OnChanges {
        ...
        svg.selectAll('circle')
            ...
            .on('click', function (d) {
                ...
                const searchWord = '*:* AND omics_type:"'
                    + DashboardReanalisysCountProfileComponent.getName(d['year'], d['value'], annualDataExtends)
