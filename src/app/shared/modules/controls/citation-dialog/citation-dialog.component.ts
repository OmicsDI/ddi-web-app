...
export class CitationDialogComponent implements OnInit {
    ...
    /**************************************************************************
     ...
     amicyanin and cytochrome c551i from Paracoccus denitrificans with the substrate-reduced, copper free complex
     at 1.9 A resolution, Protein Data Bank, V1. http://identifiers.org/pdb:2gc4.
     ...
     * For now all of our versions will be V1 until we start controlling the versioning.
     ...
     AMA style:
     [dataset] 27. Chen Z, Durley R, Davidson VL, Mathews FS. Structural comparison of the oxidized ternary
     electron transfer complex of methylamine dehydrogenase, amicyanin and cytochrome c551i from Paracoccus
