...
@Component({
    selector: 'app-omics-image-dashboard',
    templateUrl: './omics-image-dashboard.component.html',
    styleUrls: ['./omics-image-dashboard.component.css']
})
export class OmicsImageDashboardComponent implements OnInit, OnChanges {
