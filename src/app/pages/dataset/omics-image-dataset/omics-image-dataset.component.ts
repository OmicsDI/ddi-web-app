...
@Component({
    selector: 'app-omics-image-dataset',
    templateUrl: './omics-image-dataset.component.html',
    styleUrls: ['./omics-image-dataset.component.css']
})
export class OmicsImageDatasetComponent implements OnInit, OnChanges {
