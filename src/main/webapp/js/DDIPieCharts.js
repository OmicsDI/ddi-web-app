...
var pie_charts_repos_omics = function () {
    ...
    function draw_chart_repos_omics(error, domains, omicstype) {
        ...
        if (error) {
            ...
            function drawBarGraphy(data_now, data_add_key) {
                ...
                svg.selectAll("rect.lower")
                    ...
                    .attr("height", function (d) {
                        return rect_height * 3 + 28 - lower(d);
                    })
                    .style("fill", color);
                ...
                svg.selectAll("rect.upper")
                    ...
                    .attr("height", function (d) {
                        return d >= 1500 ? rect_height * 2 + 18 - upper(d) : 0;
                    })
                    .style("fill", color);
                ...
                svg.selectAll("rect.most")
                    ...
                    .attr("height", function (d) {
                        return d >= 10000 ? rect_height + 8 - most(d) : 0
                    })
                    .style('fill', color);
            ...
            function set_the_radio() {

                var div_width = parseInt(body.style("width"));
                // d3.select('#' + piechartname + '_formdiv').remove();
                var formdiv = d3.select('#' + piechartname + '_formdiv');
                if(d3.select('#' + piechartname + '_formdiv').empty()) {
                    formdiv = body.append('div');
                }
                formdiv
                ...
                if(d3.select('#' + piechartname + "_radio_form").empty()) {
                    radio_form = formdiv.append('form');
                }
                else{
                    return;
                ...
                d3.select("#" + piechartname + "_radio_form").selectAll('input')
                    .on('change', change);
            }
